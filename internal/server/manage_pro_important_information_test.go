...
type mockManageProDeputyImportantInformation struct {
	count                     int
...
func (m *mockManageProDeputyImportantInformation) GetDeputyDetails(ctx sirius.Context, _ int, _ int) (sirius.DeputyDetails, error) {
	m.count += 1
	m.lastCtx = ctx
...
func (m *mockManageProDeputyImportantInformation) GetDeputyAnnualInvoiceBillingTypes(ctx sirius.Context) ([]sirius.DeputyAnnualBillingInvoiceTypes, error) {
	m.count += 1
	m.lastCtx = ctx
...
func (m *mockManageProDeputyImportantInformation) GetDeputyComplaintTypes(ctx sirius.Context) ([]sirius.DeputyComplaintTypes, error) {
	m.count += 1
	m.lastCtx = ctx
...
func (m *mockManageProDeputyImportantInformation) UpdateProImportantInformation(ctx sirius.Context, _ int, _ sirius.ImportantProInformationDetails) error {
	m.count += 1
	m.lastCtx = ctx
...
func TestGetManageImportantInformation(t *testing.T) {
	...
	client := &mockManageProDeputyImportantInformation{}
...
func TestErrorManageImportantInformationMessageWhenIsEmpty(t *testing.T) {
	...
	assert.Equal(manageProDeputyImportantInformationVars{
		Path:     "/123",
		DeputyId: 123,
