...
func TestParseUrlReturnsColumnAndSortOrder(t *testing.T) {
	urlPassedin := "http://localhost:8888/supervision/deputies/public-authority/78/clients?sort=crec:desc"
...
func TestParseUrlReturnsEmptyStrings(t *testing.T) {
	urlPassedin := "http://localhost:8888/supervision/deputies/public-authority/78/clients"
