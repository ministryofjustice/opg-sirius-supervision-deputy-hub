...
func TestGetManageAssurance(t *testing.T) {
	...
	visit := sirius.AssuranceVisit{Id: 1, RequestedDate: sirius.FormatDateTimeStringIntoDateTime("2006-01-02T15:04:05+00:00", "2022-01-02T10:11:08+00:00"), RequestedBy: sirius.User{UserId: 2}}
...
func TestGetManagePDR(t *testing.T) {
	...
	visitOutcomeTypes := []sirius.VisitOutcomeTypes{{Handle: "x", Label: "w"}}
	pdrOutcomeTypes := []sirius.PdrOutcomeTypes{{Handle: "x", Label: "z"}}
	visit := sirius.AssuranceVisit{Id: 1, AssuranceType: sirius.AssuranceTypes{Handle: "PDR", Label: "PDR"}, RequestedDate: sirius.FormatDateTimeStringIntoDateTime("2006-01-02T15:04:05+00:00", "2022-01-02T10:11:08+00:00"), RequestedBy: sirius.User{UserId: 2}}
