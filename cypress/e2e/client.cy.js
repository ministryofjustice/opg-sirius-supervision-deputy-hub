describe("Clients tab", () => {
    ...
    describe("clients table", () => {
        ...
        it("check clients shows assurance visit button and correct error if no due date", () => {
            ...
            cy.get(':nth-child(1) > .govuk-table__select > .govuk-checkboxes > .govuk-checkboxes__item > #select-client-71').check()
            cy.get(':nth-child(2) > .govuk-table__select > .govuk-checkboxes > .govuk-checkboxes__item > #select-client-74').check()
