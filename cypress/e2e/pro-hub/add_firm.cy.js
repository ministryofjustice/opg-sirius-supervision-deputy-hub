    ...
    describe("Adding a firm", () => {
        ...
        it("shows error message when submitting invalid data", () => {
            ...
            cy.get(".govuk-error-summary__list").within(() => {
                cy.get("li:first").should("contain", "The building or street must be 255 characters or fewer");
                ...
                cy.get("li").eq(5).should("contain", "The firm name is required and can't be empty");
            ...
            cy.get(":nth-child(4) > #name-error-stringLengthTooLong").should(
                "contain",
            ...
            cy.get(":nth-child(7) > #name-error-stringLengthTooLong").should(
                "contain",
            ...
            cy.get("#add-firm-form > :nth-child(4) > #name-error-stringLengthTooLong").should(
                "contain",
            ...
            cy.get("#add-firm-form > :nth-child(5) > #name-error-stringLengthTooLong").should(
                "contain",
