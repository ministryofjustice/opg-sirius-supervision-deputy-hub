describe("Manage Deputy Contact Details", () => {
    ...
    describe("Form functionality", () => {
        ...
        it("should populate fields with current contact details", () => {
            cy.get("input[name=deputy-first-name]").should("have.value", "firstname");
            cy.get("input[name=deputy-last-name]").should("have.value", "surname");
        ...
        it("should show success banner on submit", () => {
            ...
            cy.contains(".govuk-heading-l", "Deputy details");
            cy.get("body > div > main > div.moj-banner.moj-banner--success > div").should(
                "contain",
                "Deputy details updated",
            );
        });
        ...
        it("should show validation errors", () => {
            ...
            cy.get(".govuk-error-summary__list").within(() => {
                ...
                cy.get("li").eq(5).should("contain", "The deputy first name is required and can't be empty");
                cy.get("li").eq(6).should("contain", "The postcode must be 255 characters or fewer");
                cy.get("li").eq(7).should("contain", "The deputy surname is required and can't be empty");
                cy.get("li").eq(8).should("contain", "The town or city must be 255 characters or fewer");
                cy.get("li").eq(9).should("contain", "The telephone number must be 255 characters or fewer");
            });
            ...
            cy.get("#contact-details-form > :nth-child(2) > #name-error-isEmpty").should(
                "contain",
            ...
            cy.get("#contact-details-form > :nth-child(3) > #name-error-isEmpty").should(
                "contain",
            ...
            cy.get(".govuk-fieldset > :nth-child(3) > #name-error-stringLengthTooLong").should(
                "contain",
            ...
            cy.get(".govuk-fieldset > :nth-child(4) > #name-error-stringLengthTooLong").should(
                "contain",
            ...
            cy.get(".govuk-fieldset > :nth-child(5) > #name-error-stringLengthTooLong").should(
                "contain",
            ...
            cy.get(".govuk-fieldset > :nth-child(6) > #name-error-stringLengthTooLong").should(
                "contain",
            ...
            cy.get(".govuk-fieldset > :nth-child(7) > #name-error-stringLengthTooLong").should(
                "contain",
            ...
            cy.get(".govuk-fieldset > :nth-child(8) > #name-error-stringLengthTooLong").should(
                "contain",
            ...
            cy.get("#contact-details-form > :nth-child(5) > #name-error-stringLengthTooLong").should(
                "contain",
            ...
            cy.get("#contact-details-form > :nth-child(6) > #name-error-stringLengthTooLong").should(
                "contain",
    ...
    it("should show 'Deputy name' field when deputy is organisation", () => {
        ...
        cy.get("input[name=organisation-name]").should("have.value", "Organisation Ltd");
    });
    ...
    describe("Deputy contact details changed timeline event", () => {
        ...
        it("has a timeline event for when the deputy contact details have changed", () => {
            cy.get("[data-cy=deputy-contact-details-event]").within(() => {
                ...
                cy.get(".moj-timeline__description > .govuk-list")
                    .children()
                    .first()
                    .should("contain", "Address line 1: Town Hall")
                    .next()
                    .should("contain", "Address line 2: City Centre");
            });
        });
    });
});
