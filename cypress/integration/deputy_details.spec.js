describe("Deputy details tab", () => {
    ...
    describe("Deputy contact details", () => {
        ...
        it("has a button which can take you to manage team details", () => {
            cy.get(":nth-child(6) > :nth-child(1) > .govuk-button").should(
                "contain",
                "Manage team details"
            ).click();
    ...
    describe("Important information", () => {
        ...
        it("has rows in tables with accurate keys and values", () => {
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(1) > .govuk-summary-list__key").should("contain", "Monthly spreadsheet");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(1) > .govuk-summary-list__value").should("contain", "No");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(2) > .govuk-summary-list__key").should("contain", "Independent visitor charges");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(2) > .govuk-summary-list__value").should("contain", "Unknown");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(3) > .govuk-summary-list__key").should("contain", "Bank charges");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(3) > .govuk-summary-list__value").should("contain", "Yes");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(4) > .govuk-summary-list__key").should("contain", "APAD");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(4) > .govuk-summary-list__value").should("contain", "Yes");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(5) > .govuk-summary-list__key").should("contain", "Report system");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(5) > .govuk-summary-list__value").should("contain", "CASHFAC");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(6) > .govuk-summary-list__key").should("contain", "Annual billing preference");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(6) > .govuk-summary-list__value").should("contain", "Schedule and Invoice");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(7) > .govuk-summary-list__key").should("contain", "Other important information");
            cy.get(":nth-child(2) > .govuk-summary-list > :nth-child(7) > .govuk-summary-list__value").should("contain", "some info for the pa deputy");
        });
    });
